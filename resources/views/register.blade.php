...
<head>
    ...
    <title>Register | SuratMenyorak</title>
...
<body>
  ...
  <form>
    <h1 class="h3 mb-3 fw-normal d-flex justify-content-center">Register Here</h1>

    <p class="d-flex justify-content-center">Daftar dan Atur Suratmu</p>
    ...
    <button class="w-100 btn btn-lg btn-primary mt-4 btn-success" type="submit">Simpan</button>
  </form>
</main>
</div>
</div>
